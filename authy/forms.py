...
class SignupForm(forms.ModelForm):
	...
	email = forms.CharField(widget=forms.EmailInput(attrs={"class":"input"}), max_length=100, required=True,)
	password = forms.CharField(widget=forms.PasswordInput(attrs={"class":"input"}))
	confirm_password = forms.CharField(widget=forms.PasswordInput(attrs={"class":"input"}), required=True, label="Confirm your password.")
